...
def main():
    ...
    for cluster_dimensions in cluster_dimensionslist:
        ...
        for k in k_values:
            ...
            dataset_cluster = k_means_over_instances(copy.deepcopy(
        ...
        dataset = k_means_over_instances(copy.deepcopy(dataset), cluster_dimensions, k, 'default', 20, n_inits=30, name=names[index])
        print(dataset)
